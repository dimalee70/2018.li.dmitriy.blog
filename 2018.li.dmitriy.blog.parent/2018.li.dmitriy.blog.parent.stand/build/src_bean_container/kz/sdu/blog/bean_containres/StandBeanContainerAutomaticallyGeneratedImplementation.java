...
public final class StandBeanContainerAutomaticallyGeneratedImplementation implements kz.sdu.blog.bean_containres.StandBeanContainer{
  ...
  private kz.sdu.blog.beans.StandServer get_native_StandServer_4 () {
    ...
    synchronized (forSynchronizedBlocks) {
      ...
      try {
        ...
        localValue.webAppContextRegistration = (kz.greetgo.depinject.core.BeanGetter<java.util.List<kz.sdu.blog.utils.WebAppContextRegistration>>)(java.lang.Object)getter_ref_list_WebAppContextRegistration_9;
  ...
  private final java.util.concurrent.atomic.AtomicReference<kz.sdu.blog.beans.UtfFilterRegistration> cachedValue_native_UtfFilterRegistration_5 = new java.util.concurrent.atomic.AtomicReference<>(null);
  private final kz.greetgo.depinject.core.BeanGetter<kz.sdu.blog.beans.UtfFilterRegistration> getter_native_UtfFilterRegistration_5 = this::get_native_UtfFilterRegistration_5;
  private kz.sdu.blog.beans.UtfFilterRegistration get_native_UtfFilterRegistration_5 () {
    {
      kz.sdu.blog.beans.UtfFilterRegistration x = cachedValue_native_UtfFilterRegistration_5.get();
      if (x != null) return x;
    }
    synchronized (forSynchronizedBlocks) {
      {
      ...
      try {
        kz.sdu.blog.beans.UtfFilterRegistration localValue = new kz.sdu.blog.beans.UtfFilterRegistration();
        cachedValue_native_UtfFilterRegistration_5.set(localValue);
        return localValue;
      } catch (java.lang.Exception e) {
        if (e instanceof java.lang.RuntimeException) throw (java.lang.RuntimeException) e;
        throw new java.lang.RuntimeException(e);
  ...
  private kz.sdu.blog.controller.TestController get_native_TestController_6 () {
    ...
    synchronized (forSynchronizedBlocks) {
      ...
      try {
        ...
        localValue.testRegisterBeanGetter = (kz.greetgo.depinject.core.BeanGetter<kz.sdu.blog.register.TestRegister>)(java.lang.Object)getter_native_TestRegisterImpl_7;
  ...
  private java.util.List<kz.sdu.blog.utils.WebAppContextRegistration> get_ref_list_WebAppContextRegistration_9() {
    ...
    list.add(getter_native_UtfFilterRegistration_5.get());
    return list;
  }
